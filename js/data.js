  ...
  standings: [
    {
      ...
      roundFlags: ["ae","ae"],
      drivers: [
        { name: "GT3RT-Flecha",    rounds: [16,17], total: 33 },
        ...
        { name: "Anderson Costa",  rounds: [14,6],  total: 20 },
    ...
    },
    {
      ...
      drivers: [
        { name: "Guilherme",       rounds: [40,20,35,41,28,38,0,30],  total: 220 },
        { name: "Luís Oliveira",   rounds: [18,18,19,27,26,18,41,40], total: 207 },
        { name: "Gil",             rounds: [24,8,38,35,37,17,0,0],    total: 171 },
        { name: "Pedro Venda",     rounds: [30,18,0,12,7,12,24,24],   total: 127 },
        { name: "Nuno Fonseca",    driverRef: "Nuno \"TheSnail\" PT", rounds: [0,16,12,20,10,20,15,20], total: 113 },
        { name: "Francisco Silva", rounds: [1,27,0,10,28,6,32,0],     total: 104 },
        { name: "Ricardo",         rounds: [7,25,2,0,1,13,14,36],     total: 98 },
        { name: "Marco Silva",     rounds: [0,29,15,0,0,8,17,27],     total: 96 },
        { name: "Pedro Oliveira",  rounds: [18,0,29,24,0,0,7,0],      total: 77 },
        { name: "Tiago Pacheco",   rounds: [0,0,6,16,20,26,0,0],      total: 68 },
        { name: "Pedro Lima",      rounds: [0,0,0,30,11,24,0,0],      total: 65 },
        { name: "António Brissos", rounds: [1,8,5,8,3,0,16,22],       total: 63 },
        { name: "Filipe Marroko",  rounds: [17,0,8,18,6,2,0,0],       total: 51 },
        { name: "Lon3R_Jhon",      rounds: [0,18,0,6,16,0,0,0],       total: 40 },
        { name: "Rocha",           rounds: [5,3,14,0,4,7,0,0],        total: 33 },
        { name: "Francisco",       rounds: [2,0,3,0,0,6,0,18],        total: 29 },
        { name: "Tiago Freitas",   rounds: [5,0,0,0,0,0,18,0],        total: 23 },
        { name: "Simão Melo",      driverRef: "Simão Teixeira de Melo", rounds: [0,0,0,22,0,0,0,0], total: 22 },
        { name: "Renato Oliveira", rounds: [0,0,5,14,0,0,0,0],        total: 19 },
        { name: "Hélio Sequeira",  rounds: [18,0,0,0,0,0,0,0],        total: 18 },
        { name: "Rodrigo Amorim",  rounds: [8,0,2,0,0,0,0,0],         total: 10 },
        { name: "Ricardo Duarte",  rounds: [0,6,0,0,0,0,0,0],         total: 6 },
        { name: "André Gaspar",    rounds: [0,1,4,0,0,0,0,0],         total: 5 },
        { name: "D.Sousa",         rounds: [3,0,0,0,0,0,0,0],         total: 3 },
      ]
    },
    {
      competition: "GR2",
      ...
      drivers: [
        { name: "David Noronha",    driverRef: "DAVIDNORONHA-84",      rounds: [16,12,20,20], total: 68 },
        { name: "Ricardo Melo",     driverRef: "Ricardo Melo",         rounds: [3,20,25,2],  total: 50 },
        { name: "Pedro Oliveira",   driverRef: "Pedro Oliveira",       rounds: [20,6,16,7],  total: 50 },
        { name: "Filipe Marroko",   driverRef: "Filipe Marroko",       rounds: [6,16,0,16],  total: 39 },
        { name: "Luís Oliveira",    driverRef: "Luís Oliveira",        rounds: [12,10,6,10], total: 38 },
        { name: "Francisco Silva",  driverRef: "Francisco Silva",      rounds: [8,25,4,0],   total: 37 },
        { name: "Tiago Freitas",    driverRef: "Tiago Freitas",        rounds: [0,0,10,25],  total: 36 },
        { name: "Ricardo",          driverRef: "Ricardo",              rounds: [10,2,2,12],  total: 26 },
        { name: "Pedro Ribeiro",    driverRef: "frm_pribeiro",         rounds: [25,0,0,0], total: 25 },
        { name: "Nuno \"TheSnail\" PT", driverRef: "Nuno \"TheSnail\" PT", rounds: [4,0,12,4], total: 21 },
        { name: "Rui Rei",          driverRef: "Rui Rei",              rounds: [0,4,3,8],  total: 15 },
        { name: "Marco Silva",      driverRef: "Marco Silva",          rounds: [0,8,0,3],  total: 11 },
        { name: "Ruben Santos",     driverRef: "Rsantos059",           rounds: [0,0,8,0],  total: 8 },
        { name: "António Brissos",  driverRef: "António Brissos",      rounds: [0,3,0,0],  total: 3 },
        { name: "João Silva",       driverRef: "PRT_SILVAJOHNNY",      rounds: [2,0,0,0],  total: 2 },
        { name: "Alvaro Menino",    driverRef: "alvaro_menino",        rounds: [0,0,0,0],  total: 0 },
        { name: "Basaroco",         driverRef: "Basaroco75",           rounds: [0,0,0,0],  total: 0 },
        { name: "Lon3R_Jhon",       driverRef: "Lon3R_Jhon",           rounds: [0,0,0,0],  total: 0 },
        { name: "Pedro Venda",      driverRef: "Pedro Venda",          rounds: [0,0,0,0],  total: 0 },
        { name: "Rocha",            driverRef: "Rocha",                rounds: [0,0,0,0],  total: 0 },
      ]
    }
  ],
